...
<!-- メールアドレス -->
        <tr class="confirm-form__row">
          ...
          <td class="confirm-form__data">{{ $contacts['email'] }}
          </td>
...
<!-- 電話番号 -->
        <tr class="confirm-form__row">
          ...
          <td class="confirm-form__data">{{ $contacts['tel_1'] }}{{ $contacts['tel_2'] }}{{ $contacts['tel_3'] }}
          </td>
...
<!-- お問い合わせ内容 -->
        <tr class="confirm-form__row">
          <th class="confirm-form__label">お問い合わせの内容</th>
